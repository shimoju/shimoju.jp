...
assert.match(read('assets/theme.css'), /--font-body: -apple-system, BlinkMacSystemFont, "Segoe UI", "Hiragino Sans", "Noto Sans JP", sans-serif;/);
assert.match(read('assets/theme.css'), /"Hiragino Sans", "Noto Sans JP", sans-serif/);
