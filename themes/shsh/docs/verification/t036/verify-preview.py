"""Read-only HTTP verification of the T035 Pages Git preview."""
import hashlib
import json
import re
...
BASE = 'https://59e83710.shimoju.pages.dev/'
...
for url in sorted(assets):
    ...
    records.append(record)
report={'recorded_at':datetime.now(timezone.utc).isoformat(),'commit':'6f100d5e2c9f585d4117755966528bf542b39455','base_url':BASE,'result':'passed','responses':records}
