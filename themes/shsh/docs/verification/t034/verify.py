...
target = {"environment": environment, "base_url": "https://shimoju.jp/" if environment == "production" else "https://t034.shimoju.pages.dev/"}
root = Path(f".cache/t034-{environment}")
...
output = Path("docs/verification/t034") / f"{target['environment']}-output.json"
