...
対象は固定preview6f52990f（268bbb0）と各既存報告に記録した版。以下は依頼時の手順として保持し、追加試験の一律依頼ではない。本番配信は[T071](../t071/README.md)、旧テーマ整理は[T018](../t018/README.md)で確認した。
...
本番のURL/RSS/共有/スター/HTTP検証はT071、PaperMod整理・最終監査はT018を参照する。
