...
| Pocophone F1 / Android Chrome | 実フォント未取得と文字のみの拡大設定なしの扱い（F027判断待ち）。版・コピー一致・150%ページズーム・4種表示と動画/スライド操作・JS無効の本文/Next/ナビ/RSS/ボタン非表示はT067で確認済み |
...
Androidの受領済み報告と未確認の区別は[T067](../t067/README.md)を参照。以下の手順は未確認の項目へ適用する。
