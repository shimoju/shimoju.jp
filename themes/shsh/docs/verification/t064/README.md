...
| iPhone 17 / Safari  | 実フォント未取得の扱い（F028判断待ち）。iOS 27.0付属最新版、150%文字拡大、外部4種表示/操作、JS無効の本文/Next/ナビ/RSS/ボタン非表示はT069で確認済み |
...
AndroidはF027の承認により代表範囲を確認完了。実フォント未取得と文字のみ拡大未実施は制約として保持し、拡大確認は150%ページズームを採用する（[T068](../t068/README.md)）。以下の手順は未確認の項目へ適用する。
