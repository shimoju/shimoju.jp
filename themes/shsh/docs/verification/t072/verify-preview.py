"""Read-only HTTP verification of PR #6's fixed preview."""
...
BASE = "https://2d53dd57.shimoju.pages.dev"
DEVICE_BASE = "https://6f52990f.shimoju.pages.dev"
SHA = "6b82005621a408526365fb9327f8478599f3be2c"
...
def fetch(url, follow=True):
    ...
    with tempfile.TemporaryDirectory(prefix="shsh-t072-") as directory:
        temp = Path(directory)
