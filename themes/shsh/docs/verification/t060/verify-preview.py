...
BASE = "https://919f4ced.shimoju.pages.dev"
DEVICE_BASE = "https://6f52990f.shimoju.pages.dev"
SHA = "9f173698093ef0c0e773c840859b6246c2bb656a"
...
def fetch(url, follow=True):
    ...
    with tempfile.TemporaryDirectory(prefix="shsh-t060-") as directory:
        temp = Path(directory)
...
missing, _ = fetch(BASE + "/t060-deliberately-missing-page/")
