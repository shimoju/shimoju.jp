...
entries contain no purple. A 360×180 Catmull-Rom resize should produce RGB
(128, 0, 128) away from the image and alpha edges while preserving the alpha
of each half. This detects palette reapplication between resizing and lossless
WebP encoding without using Hugo to generate the expected pixels.
