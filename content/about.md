...
2019年からはシニアエンジニアとして、技術選定やセキュリティ対策をリードする立場となった。エンジニア採用や同僚の成長支援を通してチームビルディングに取り組んでいるほか、2020年以降はSLI/SLOの策定・運用、パフォーマンス改善やインフラの構築といったSRE活動にも携わる。
...
しかしYJITによる高速化の恩恵をいち早く受けるため、Rails 6.1のままRuby 3.2へのアップデートを実施した。
