...
それに対して、今回アップデートしたモノリスでは以下の流れにしました（それぞれの詳細については後述）。
...
このアプリでは[graphql](https://github.com/rmosolgo/graphql-ruby)や[committee](https://github.com/interagent/committee)が古いバージョンで止まっており、運良くRuby 3.2のブロッカーにはなりませんでしたが今後やらないといけない…。
