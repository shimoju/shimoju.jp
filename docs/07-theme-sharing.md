...
共有・フッターのSVGは24×24のviewBoxと`currentColor`を共用し、ライトではLatte Text、ダークではMocha Textに追従する。アイコンは1.456rem、リンク幅は2.560rem、最小高さは共有2.560rem・フッター2.75rem。ボタン間隔は0.754rem、スターとの間隔は1.207remとし、狭い幅では折り返す。
